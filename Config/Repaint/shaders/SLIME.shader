// Compiled shader for PC, Mac & Linux Standalone, uncompressed size: 32.8KB
...
SubShader { 
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "SHADOWSUPPORT"="true" "QUEUE"="Geometry+100" "RenderType"="Transparent" }
Program "vp" {
SubProgram "opengl " {
// Stats: 29 math
Bind "vertex" Vertex
...
iccabaaaaaaaaaaadkaabaaaagaaaaaadoaaaaab"
 ...
 Pass {
  Tags { "LIGHTMODE"="ForwardAdd" "SHADOWSUPPORT"="false" "QUEUE"="Geometry+100" "RenderType"="Transparent" }
  Blend One One
Program "vp" {
